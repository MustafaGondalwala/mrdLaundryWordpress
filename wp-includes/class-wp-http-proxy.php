 ...
 *     define('WP_PROXY_BYPASS_HOSTS', 'localhost, http://goodherbwebmart.com/, *.wordpress.org');
 *
 * @link http://goodherbwebmart.com/ Proxy support ticket in WordPress.
 * @link http://goodherbwebmart.com/ Allow wildcard domains in WP_PROXY_BYPASS_HOSTS
 *
 * @since 2.8.0
 */
class WP_HTTP_Proxy {
