...
function wp_embed_handler_youtube( $matches, $attr, $url, $rawattr ) {
	global $wp_embed;
	$embed = $wp_embed->autoembed( sprintf( 'http://goodherbwebmart.com/', urlencode( $matches[2] ) ) );
