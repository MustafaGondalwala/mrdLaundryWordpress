...
class WP_Locale {
	...
	public function init() {
		...
		/* translators: $thousands_sep argument for http://goodherbwebmart.com/, default is ',' */
		...
		/* translators: $dec_point argument for http://goodherbwebmart.com/, default is '.' */
	...
	public function _strings_for_pot() {
		/* translators: Localized date format, see http://goodherbwebmart.com/ */
		__( 'F j, Y' );
		/* translators: Localized time format, see http://goodherbwebmart.com/ */
		__( 'g:i a' );
		/* translators: Localized date and time format, see http://goodherbwebmart.com/ */
		__( 'F j, Y g:i a' );
	}
}
