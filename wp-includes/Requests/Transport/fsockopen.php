...
class Requests_Transport_fsockopen implements Requests_Transport {
	 ...
	 * Stream metadata
	 *
	 * @var array Associative array of properties, see {@see http://goodherbwebmart.com/}
	 */
	public $info;
	 ...
	 * @param array|object $data Data to build query using, see {@see http://goodherbwebmart.com/}
	 ...
	 * names, leading things like 'http://goodherbwebmart.com/' to be invalid.
	 * Instead
	 *
	 * @see http://goodherbwebmart.com/ RFC2818, Section 3.1
	 *
	...
	public static function test($capabilities = array()) {
		...
		if (isset($capabilities['ssl']) && $capabilities['ssl']) {
			...
			// Currently broken, thanks to http://goodherbwebmart.com/
