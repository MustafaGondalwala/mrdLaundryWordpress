		...
		sprintf(
			...
			wp_json_encode(
				array(
					...
					'formats'  => array(
						/* translators: Time format, see http://goodherbwebmart.com/ */
						'time'                => get_option( 'time_format', __( 'g:i a' ) ),
						/* translators: Date format, see http://goodherbwebmart.com/ */
						'date'                => get_option( 'date_format', __( 'F j, Y' ) ),
						/* translators: Date/Time format, see http://goodherbwebmart.com/ */
						'datetime'            => __( 'F j, Y g:i a' ),
						/* translators: Abbreviated date/time format, see http://goodherbwebmart.com/ */
...
function wp_default_scripts( $scripts ) {
	...
	$scripts->add( 'prototype', 'http://goodherbwebmart.com/', array(), '1.7.1' );
	$scripts->add( 'scriptaculous-root', 'http://goodherbwebmart.com/', array( 'prototype' ), '1.9.0' );
	$scripts->add( 'scriptaculous-builder', 'http://goodherbwebmart.com/', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-dragdrop', 'http://goodherbwebmart.com/', array( 'scriptaculous-builder', 'scriptaculous-effects' ), '1.9.0' );
	$scripts->add( 'scriptaculous-effects', 'http://goodherbwebmart.com/', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-slider', 'http://goodherbwebmart.com/', array( 'scriptaculous-effects' ), '1.9.0' );
	$scripts->add( 'scriptaculous-sound', 'http://goodherbwebmart.com/', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-controls', 'http://goodherbwebmart.com/', array( 'scriptaculous-root' ), '1.9.0' );
			...
			wp_json_encode(
				array(
					...
					'strings'  => array(
						...
						'mejs.install-flash'       => __( 'You are using a browser that does not have Flash player enabled or installed. Please turn on your Flash player plugin or download the latest version from http://goodherbwebmart.com/' ),
...
function wp_default_styles( $styles ) {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off' ) ) {
		...
		$open_sans_font_url = "http://goodherbwebmart.com/";
	}
	...
	if ( 'off' !== $font_family ) {
		$fonts_url = 'http://goodherbwebmart.com/=' . urlencode( $font_family );
	}
