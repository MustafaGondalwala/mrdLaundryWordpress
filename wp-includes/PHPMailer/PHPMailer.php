 ...
 * PHP Version 5.5.
 *
 * @see http://goodherbwebmart.com/ The PHPMailer GitHub project
 *
 ...
 * @license   http://goodherbwebmart.com/ GNU Lesser General Public License
...
class PHPMailer
{
     ...
     * (e.g. "http://goodherbwebmart.com/;http://goodherbwebmart.com/").
     ...
     *
     * @see http://goodherbwebmart.com/ See section 4.1 for more information about NOTIFY
     */
    public $dsn = '';
     ...
     *
     * @see http://goodherbwebmart.com/
     * @see http://goodherbwebmart.com/ Postfix VERP info
     *
     * @var bool
     */
     ...
     *
     * Value can be any php callable: http://goodherbwebmart.com/
     *
     * Parameters:
     ...
     *
     * @see http://goodherbwebmart.com/ A more careful implementation
     *
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'html5':
                 ...
                 *
                 * @see http://goodherbwebmart.com/-(type=email)
                 */
                return (bool) preg_match(
     ...
     *
     * @see http://goodherbwebmart.com/ CVE-2016-10045 bug report
     *
    ...
    protected function mailSend($header, $body)
    {
        ...
        //Exim docs: http://goodherbwebmart.com/
        //Sendmail docs: http://goodherbwebmart.com/
        //Qmail docs: http://goodherbwebmart.com/
        //Example problem: http://goodherbwebmart.com/
        // CVE-2016-10033, CVE-2016-10045: Don't pass -f if characters will be escaped.
    ...
    public function createHeader()
    {
        ...
        if ('' === $this->XMailer) {
            $result .= $this->headerLine(
                'X-Mailer',
                'PHPMailer ' . self::VERSION . ' (http://goodherbwebmart.com/)'
            );
        } else {
...
//            $result .= static::$LE;
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                //Workaround for PHP bug http://goodherbwebmart.com/
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' === $key) {
                ...
                return $this->language[$key] . ' http://goodherbwebmart.com/';
            }
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        //Recommended list from http://goodherbwebmart.com/
        $autoSignHeaders = [
            'from',
            'to',
            'cc',
