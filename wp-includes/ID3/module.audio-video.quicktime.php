...
class getid3_quicktime extends getid3_handler
{
	...
	public function QuicktimeParseAtom($atomname, $atomsize, $atom_data, $baseoffset, &$atomHierarchy, $ParseAllPossibleAtoms) {
		...
		$atom_parent = end($atomHierarchy); // not array_pop($atomHierarchy); see http://goodherbwebmart.com/
...
//					if (true) {
	...
	/* due to lack of known documentation, this is a kludge implementation. If you know of documentation on how mdat is properly structed, please send it to info@getid3.org */
				...
				case 'PrmA':
				case 'code':
				case 'FIEL': // this is NOT "fiel" (Field Ordering) as describe here: http://goodherbwebmart.com/
				case 'tapt': // TrackApertureModeDimensionsAID - http://goodherbwebmart.com/
							// tapt seems to be used to compute the video size [http://goodherbwebmart.com/]
							// * http://goodherbwebmart.com/
							// * http://goodherbwebmart.com/
				case 'ctts'://  STCompositionOffsetAID             - http://goodherbwebmart.com/
				case 'cslg'://  STCompositionShiftLeastGreatestAID - http://goodherbwebmart.com/
				case 'sdtp'://  STSampleDependencyAID              - http://goodherbwebmart.com/
				case 'stps'://  STPartialSyncSampleAID             - http://goodherbwebmart.com/
					//$atom_structure['data'] = $atom_data;
					break;
				...
				case 'NCVW': // Nikon Camera preVieW image
					...
					break;
				case 'NCTG': // Nikon - http://goodherbwebmart.com/
					$atom_structure['data'] = $this->QuicktimeParseNikonNCTG($atom_data);
					break;
				case 'NCHD': // Nikon:MakerNoteVersion  - http://goodherbwebmart.com/
				case 'NCDB': // Nikon                   - http://goodherbwebmart.com/
				case 'CNCV': // Canon:CompressorVersion - http://goodherbwebmart.com/
					$atom_structure['data'] = $atom_data;
					break;
				...
				case 'uuid': // user-defined atom often seen containing XML data, also used for potentially many other purposes, only a few specifically handled by getID3 (e.g. 360fly spatial data)
					...
					switch ($atom_structure['uuid_field_id']) {   // http://goodherbwebmart.com/

						case '0537cdab-9d0c-4431-a72a-fa561f2a113e': // Exif                                       - http://goodherbwebmart.com/
						case '2c4c0100-8504-40b9-a03e-562148d6dfeb': // Photoshop Image Resources                  - http://goodherbwebmart.com/
						case '33c7a4d2-b81d-4723-a0ba-f1a3e097ad38': // IPTC-IIM                                   - http://goodherbwebmart.com/
						case '8974dbce-7be7-4c51-84f9-7148f9882554': // PIFF Track Encryption Box                  - http://goodherbwebmart.com/
						case '96a9f1f1-dc98-402d-a7ae-d68e34451809': // GeoJP2 World File Box                      - http://goodherbwebmart.com/
						case 'a2394f52-5a9b-4f14-a244-6c427c648df4': // PIFF Sample Encryption Box                 - http://goodherbwebmart.com/
						case 'b14bf8bd-083d-4b43-a5ae-8cd7d5a6ce03': // GeoJP2 GeoTIFF Box                         - http://goodherbwebmart.com/
						case 'd08a4f18-10f3-4a82-b6c8-32d8aba183d3': // PIFF Protection System Specific Header Box - http://goodherbwebmart.com/
	...
	public function QuicktimeLanguageLookup($languageid) {
		...
		if (($languageid > 138) && ($languageid < 32767)) {
			/*
			ISO Language Codes - http://goodherbwebmart.com/
	...
	public function CopyToAppropriateCommentsSection($keyname, $data, $boxname='') {
		...
		if (empty($handyatomtranslatorarray)) {
			...
			// http://goodherbwebmart.com/
			$handyatomtranslatorarray['PLAY_COUNTER']                = 'play_counter'; // Foobar2000 - http://goodherbwebmart.com/
			$handyatomtranslatorarray['MEDIATYPE']                   = 'mediatype';    // Foobar2000 - http://goodherbwebmart.com/
			*/
		}
		$info = &$this->getid3->info;
		$comment_key = '';
