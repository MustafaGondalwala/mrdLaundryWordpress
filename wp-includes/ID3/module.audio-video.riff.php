...
//  available at http://goodherbwebmart.com/       //
//            or http://goodherbwebmart.com/                        //
//            or http://goodherbwebmart.com/                 //
...
class getid3_riff extends getid3_handler
{
	...
	public function Analyze() {
		...
		switch ($RIFFtype) {
			...
			case 'SDSS':  // SDSS is identical to RIFF, just renamed. Used by SmartSound QuickTracks (http://goodherbwebmart.com/)
				...
				if (isset($thisfile_riff_WAVE['iXML'][0]['data'])) {
					...
					if ($parsedXML = getid3_lib::XML2array($thisfile_riff_WAVE['iXML'][0]['data'])) {
						...
						if (isset($parsedXML['SPEED']['TIMESTAMP_SAMPLES_SINCE_MIDNIGHT_LO']) && !empty($parsedXML['SPEED']['TIMESTAMP_SAMPLE_RATE']) && !empty($thisfile_riff_WAVE['iXML'][0]['timecode_rate'])) {
							...
							$timestamp_sample_rate = (is_array($parsedXML['SPEED']['TIMESTAMP_SAMPLE_RATE']) ? max($parsedXML['SPEED']['TIMESTAMP_SAMPLE_RATE']) : $parsedXML['SPEED']['TIMESTAMP_SAMPLE_RATE']); // XML could possibly contain more than one TIMESTAMP_SAMPLE_RATE tag, returning as array instead of integer [why? does it make sense? perhaps doesn't matter but getID3 needs to deal with it] - see http://goodherbwebmart.com/
...
*/
	...
	public static function ParseDIVXTAG($DIVXTAG, $raw=false) {
		// structure from "IDivX" source, Form1.frm, by "Greg Frazier of Daemonic Software Group", email: gfrazier@icestorm.net, web: http://goodherbwebmart.com/
		// source available at http://goodherbwebmart.com/
	...
	public static function wFormatTagLookup($wFormatTag) {
		...
		/** This is not a comment!
			...
			0x1FC4	NCT Soft ALF2CD (http://goodherbwebmart.com/)
			0x2000	Dolby AC3
			0x2001	Dolby DTS
	...
	public static function fourccLookup($fourcc) {
		...
		/** This is not a comment!
			...
			DVMA	Darim Vision DVMPEG (dummy for MPEG compressor) (http://goodherbwebmart.com/)
			...
			EM2V	Etymonix MPEG-2 I-frame (http://goodherbwebmart.com/)
			EKQ0	Elsa ?EKQ0?
			ELK0	Elsa ?ELK0?
			ESCP	Eidos Escape
			...
			FRWT	Darim Vision Forward Motion JPEG (http://goodherbwebmart.com/)
			FRWU	Darim Vision Forward Uncompressed (http://goodherbwebmart.com/)
			...
			IUYV	Interlaced version of UYVY (http://goodherbwebmart.com/)
			IY41	Interlaced version of Y41P (http://goodherbwebmart.com/)
			...
			LSVM	Vianet Lighting Strike Vmail (Streaming) (http://goodherbwebmart.com/)
			LEAD	LEAD Video Codec
			Ljpg	LEAD MJPEG Codec
			MDVD	Alex MicroDVD Video (hacked MS MPEG-4) (http://goodherbwebmart.com/)
			MJPA	Morgan Motion JPEG (MJPA) (http://goodherbwebmart.com/)
			MJPB	Morgan Motion JPEG (MJPB) (http://goodherbwebmart.com/)
			...
			MSZH	LCL (Lossless Codec Library) (http://goodherbwebmart.com/)
			...
			NT00	NewTek LightWave HDTV YUV w/ Alpha (http://goodherbwebmart.com/)
			NUV1	NuppelVideo
			...
			Q1.0	Q-Team\'s QPEG 1.0 (http://goodherbwebmart.com/)
			Q1.1	Q-Team\'s QPEG 1.1 (http://goodherbwebmart.com/)
			QPEG	Q-Team QPEG 1.0
			qpeq	Q-Team QPEG 1.1
			RGB 	Raw BGR32
			RGBA	Raw RGB w/ Alpha
			RMP4	REALmagic MPEG-4 (unauthorized XVID copy) (http://goodherbwebmart.com/)
			ROQV	Id RoQ File Video Decoder
			RPZA	Quicktime Apple Video (RPZA)
			RUD0	Rududu video codec (http://goodherbwebmart.com/)
			...
			SPIG	Radius Spigot
			SPLC	Splash Studios ACM Audio Codec (http://goodherbwebmart.com/)
			...
			TM2A	Duck TrueMotion Archiver 2.0 (http://goodherbwebmart.com/)
			TVJP	Pinnacle/Truevision Targa 2000 board (TVJP)
			TVMJ	Pinnacle/Truevision Targa 2000 board (TVMJ)
			TY0N	Tecomac Low-Bit Rate Codec (http://goodherbwebmart.com/)
			...
			UMP4	UB Video MPEG 4 (http://goodherbwebmart.com/)
			...
			V261	Lucent VX2000S
			VIFP	VFAPI Reader Codec (http://goodherbwebmart.com/)
			VIV1	FFmpeg H263+ decoder
			VIV2	Vivo H.263
			VQC2	Vector-quantised codec 2 (research) http://goodherbwebmart.com/)
			...
			XYZP	Extended PAL format XYZ palette (http://goodherbwebmart.com/)
			x263	Xirlink H.263
			XLV0	NetXL Video Decoder
			XMPG	Xing MPEG (I-Frame only)
			XVID	XviD MPEG-4 (http://goodherbwebmart.com/)
			XXAN	?XXAN?
			YU92	Intel YUV (YU92)
			YUNV	Nvidia Uncompressed YUV 4:2:2
			YUVP	Extended PAL format YUV palette (http://goodherbwebmart.com/)
			...
			ZLIB	Lossless Codec Library zlib compression (http://goodherbwebmart.com/)
