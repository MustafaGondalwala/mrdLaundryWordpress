...
class getid3_mp3 extends getid3_handler
{
	...
	public function decodeMPEGaudioHeader($offset, &$info, $recursivesearch=true, $ScanAsCBR=false, $FastMPEGheaderScan=false) {
		...
		if (substr($headerstring, 4 + 32, 4) == 'VBRI') {
			...
			// specs taken from http://goodherbwebmart.com/
...
//				}
				...
				if (substr($headerstring, $VBRidOffset + 120, 4) == 'LAME') {
					...
					if ((($thisfile_mpeg_audio_lame['integer_version'][0] * 1000) + $thisfile_mpeg_audio_lame['integer_version'][1]) >= 3090) { // cannot use string version compare, may have "LAME3.90" or "LAME3.100" -- see http://goodherbwebmart.com/
						...
						// Offsets of various bytes in http://goodherbwebmart.com/
