	...
	private function notice_tracker() {
		...
		<div class="notice updated elementor-message">
			<div class="elementor-message-inner">
				...
				<div class="elementor-message-content">
					<p><?php echo esc_html( $tracker_description_text ); ?> <a href="http://goodherbwebmart.com/" target="_blank"><?php echo __( 'Learn more.', 'elementor' ); ?></a></p>
		...
		<div class="notice updated is-dismissible elementor-message elementor-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="elementor-message-inner">
				...
				<div class="elementor-message-content">
					...
					<p class="elementor-message-actions">
						<a href="http://goodherbwebmart.com/" target="_blank" class="button button-primary"><?php _e( 'Happy To Help', 'elementor' ); ?></a>
		...
		<div class="notice updated is-dismissible elementor-message elementor-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="elementor-message-inner">
				...
				<div class="elementor-message-content">
					...
					<p class="elementor-message-actions">
						<a href="http://goodherbwebmart.com/" target="_blank" class="button button-secondary"><?php _e( 'Learn More', 'elementor' ); ?></a>
					</p>
				</div>
			</div>
		</div>
