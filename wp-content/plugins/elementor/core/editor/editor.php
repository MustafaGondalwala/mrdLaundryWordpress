	...
	public function enqueue_scripts() {
		...
		$config = [
			...
			'icons' => [
				...
				'goProURL' => Utils::get_pro_link( 'http://goodherbwebmart.com/' ),
			],
			'filesUpload' => [
			...
			'elementor_site' => 'http://goodherbwebmart.com/',
			'docs_elementor_site' => 'http://goodherbwebmart.com/',
			'help_the_content_url' => 'http://goodherbwebmart.com/',
			'help_right_click_url' => 'http://goodherbwebmart.com/',
			'help_flexbox_bc_url' => 'http://goodherbwebmart.com/',
			'elementPromotionURL' => 'http://goodherbwebmart.com/',
			'dynamicPromotionURL' => 'http://goodherbwebmart.com/',
			...
			'preview' => [
				'help_preview_error_url' => 'http://goodherbwebmart.com/',
				'help_preview_http_error_url' => 'http://goodherbwebmart.com/',
				'help_preview_http_error_500_url' => 'http://goodherbwebmart.com/',
			...
			'i18n' => [
				...
				'dialog_confirm_enable_fa5' => __( 'Elementor v2.6 includes an upgrade from Font Awesome 4 to 5. In order to continue using icons, be sure to click "Upgrade".', 'elementor' ) . ' <a href="http://goodherbwebmart.com/" target="_blank">' . __( 'Learn More', 'elementor' ) . '</a>',
