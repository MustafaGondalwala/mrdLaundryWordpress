...
class Settings extends Settings_Page {
	...
	public function handle_external_redirects() {
		...
		if ( 'go_elementor_pro' === $_GET['page'] ) {
			wp_redirect( Utils::get_pro_link( 'http://goodherbwebmart.com/' ) );
			die;
		}

		if ( 'go_knowledge_base_site' === $_GET['page'] ) {
			wp_redirect( 'http://goodherbwebmart.com/' );
			die;
		}
	}
				...
				<div class="e-getting-started__box postbox">
					...
					<div class="e-getting-started__content">
						...
						<div class="e-getting-started__video">
							<iframe width="620" height="350" src="http://goodherbwebmart.com/;controls=1&amp;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						...
						<div class="e-getting-started__actions e-getting-started__content--narrow">
							...
							<a href="http://goodherbwebmart.com/" target="_blank" class="button button-secondary button-hero"><?php echo __( 'Watch the Full Guide', 'elementor' ); ?></a>
						</div>
					</div>
				</div>
			</div>
	...
	public function elementor_custom_fonts() {
		...
		<div class="wrap">
			<div class="elementor-blank_state">
				...
				<a class="elementor-button elementor-button-default elementor-button-go-pro" target="_blank" href="<?php echo Utils::get_pro_link( 'http://goodherbwebmart.com/' ); ?>"><?php echo __( 'Go Pro', 'elementor' ); ?></a>
			</div>
		</div><!-- /.wrap -->
		<?php
	}
						...
						'fields' => [
							'allow_tracking' => [
								...
								'field_args' => [
									...
									'value' => 'yes',
									'default' => '',
									'sub_desc' => __( 'Become a super contributor by opting in to share non-sensitive plugin data and to receive periodic email updates from us.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'http://goodherbwebmart.com/', __( 'Learn more.', 'elementor' ) ),
								],
							...
							'optimized_dom_output' => [
								...
								'field_args' => [
									...
									'desc' => __( 'Developers, Please Note! If you\'ve used custom code in Elementor, you might have experienced a snippet of code not running. Legacy DOM Output allows you to keep prior Elementor markup output settings, and have that lovely code running again.', 'elementor' )
										. '<a href="http://goodherbwebmart.com/" target="_blank"> ' . __( 'Learn More', 'elementor' ) . '</a>',
								],
							],
						],
					],
