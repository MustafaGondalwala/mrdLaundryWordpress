	...
	public function post_elementor_rollback() {
		...
		$rollback = new Rollback(
			[
				...
				'package_url' => sprintf( 'http://goodherbwebmart.com/', $plugin_slug, $_GET['version'] ),
			]
		);
					...
					'replace_url' => [
						...
						'fields' => [
							'replace_url' => [
								...
								'field_args' => [
									'type' => 'raw_html',
									'html' => sprintf( '<input type="text" name="from" placeholder="http://goodherbwebmart.com/" class="medium-text"><input type="text" name="to" placeholder="http://goodherbwebmart.com/" class="medium-text"><button data-nonce="%s" class="button elementor-button-spinner" id="elementor-replace-url-button">%s</button>', wp_create_nonce( 'elementor_replace_url' ), __( 'Replace URL', 'elementor' ) ),
