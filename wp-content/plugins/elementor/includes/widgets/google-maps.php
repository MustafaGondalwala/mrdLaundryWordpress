...
class Widget_Google_Maps extends Widget_Base {
	...
	protected function render() {
		...
		printf(
			'<div class="elementor-custom-embed"><iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://goodherbwebmart.com/;t=m&amp;z=%2$d&amp;output=embed&amp;iwloc=near" title="%3$s" aria-label="%3$s"></iframe></div>',
