	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'hide_in_inner' => true,
				'description' => __( 'Stretch the section to the full width of the page using JS.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'http://goodherbwebmart.com/', __( 'Learn more.', 'elementor' ) ),
				'render_type' => 'none',
