...
<div class="ekit-admin-section ekit-admin-dual-layout ekit-admin-documentation-section">
    ...
    <div class="ekit-admin-right-content">
        ...
        <p><?php esc_html_e('Get started by spending some time with the documentation to get familiar with ElementsKit_Lite. Build awesome websites for you or your clients with ease.', 'elementskit-lite'); ?></p>
        <div class="ekit-admin-right-content--button">
            <a target="_blank" href="http://goodherbwebmart.com/" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-newspaper-o"></i><?php esc_html_e('Get started', 'elementskit-lite'); ?></a>
        </div>
    </div>
</div>
...
<div class="ekit-admin-section ekit-admin-faq-section">
    <div class="ekit-admin-right-content attr-text-center">
        ...
        <p><?php esc_html_e('Get started by spending some time with the documentation to get familiar with ElementsKit_Lite.', 'elementskit-lite'); ?></p>
    </div>

    <div class="ekit-admin-video-tutorial-list">
        <div class="ekit-admin-video-tutorial-item">
            <a target="_blank" href="http://goodherbwebmart.com/">
    ...
    <div class="ekit-admin-right-content--button attr-text-center">
        <a target="_blank" href="http://goodherbwebmart.com/" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-check-circle"></i><?php esc_html_e('View more videos', 'elementskit-lite'); ?></a>
    </div>
</div>
...
<div class="ekit-admin-section ekit-admin-faq-section" style="display: none">
    ...
    <div class="ekit-admin-accordion">
        <div class="ekit-admin-single-accordion">
            <h2 class="ekit-admin-single-accordion--heading"><?php esc_html_e('1. How to create a shop page in ElementsKit_Lite?', 'elementskit-lite'); ?></h2>
    ...
    <div class="ekit-admin-right-content--button attr-text-center">
        <a target="_blank" href="http://goodherbwebmart.com/" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-question-circle"></i><?php esc_html_e('View all faq’s', 'elementskit-lite'); ?></a>
    </div>
</div>
...
<div class="ekit-admin-right-content">
        <div class="ekit-admin-right-content--heading">
            <h2><?php esc_html_e('Top-class Friendly Support', 'elementskit-lite') ?></h2>
            <span class="ekit-admin-right-content--heading__sub-title"><?php esc_html_e('Support', 'elementskit-lite') ?></span>
        </div> 
        <p><?php esc_html_e('Get started by spending some time with the documentation to get familiar with ElementsKit_Lite. Build awesome websites for you or your clients with ease.', 'elementskit-lite'); ?></p>
        <div class="ekit-admin-right-content--button">
            <a target="_blank" href="http://goodherbwebmart.com/" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-question-circle"></i><?php esc_html_e('Join support forum', 'elementskit-lite'); ?></a>
        </div>
    </div>
...
<div class="ekit-admin-section ekit-admin-dual-layout ekit-admin-feature-request-section ekit-admin-except-title">
    <div class="ekit-admin-left-thumb">
        <img src="<?php echo self::get_url() . 'assets/images/featured-request-thumb.png'; ?>" alt="<?php esc_attr_e('Feature Request Thumb', 'elementskit-lite'); ?>">
    </div>
    <div class="ekit-admin-right-content">

        <p><?php esc_html_e('Maybe we’re missing something you can’t live without.', 'elementskit-lite'); ?></p>
        <div class="ekit-admin-right-content--button">
            <a target="_blank" href="http://goodherbwebmart.com/" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-check-circle"></i><?php esc_html_e('Feature request', 'elementskit-lite'); ?></a>
        </div>
    </div>
</div>
...
<div class="ekit-admin-section ekit-admin-dual-layout ekit-admin-rate-now-section ekit-admin-except-title">
    ...
    <div class="ekit-admin-right-content">
        ...
        <div class="ekit-admin-right-content--button">
            <a target="_blank" href="http://goodherbwebmart.com/" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-star"></i><?php esc_html_e('Rate it now', 'elementskit-lite'); ?></a>
        </div>
    </div>
