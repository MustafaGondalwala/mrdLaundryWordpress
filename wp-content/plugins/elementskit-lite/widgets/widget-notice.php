        ...
        if(\ElementsKit_Lite::package_type() != 'pro'){
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '1',
                    'toggle'    => false,
                    'description' => '<span class="ekit-widget-pro-feature"> Get the  <a href="http://goodherbwebmart.com/" target="_blank">Pro version</a> for more awesome elements and powerful modules.</span>',
                ]
            );
