    ...
    public function pro_panel_notice($element) {
        $element->add_control(
            ...
            [
                ...
                'toggle'        => false,
                'separator'     => 'before',
                'description'   => sprintf( __('%s Get the %s Pro version %s for more awesome elements and powerful modules. %s', 'elementskit-lite'), '<span class="ekit-widget-pro-feature">', '<a href="http://goodherbwebmart.com/" target="_blank">', '</a>', '</span>' ),
            ]
        );
    }
