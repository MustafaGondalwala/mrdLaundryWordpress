...
<script type="text/template" id="tmpl-astra-sites-pro-site-description">
	<p>
		<?php
			...
			printf( __( 'This is a premium template available with \'Agency\' package. you can purchase it from <a href="%s" target="_blank">here</a>.', 'astra-sites' ), 'http://goodherbwebmart.com/' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		?>
	</p>
	<p>
		<?php
			/* translators: %s is article link */
			printf( __( 'If you already own an Agency pack. Read an article to know how you can <a href="%s" target="_blank">import a premium website demo</a>.', 'astra-sites' ), esc_url( 'http://goodherbwebmart.com/' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		?>
	</p>
</script>
...
<script type="text/template" id="tmpl-astra-sites-pro-inactive-site-description">
	...
	<p>
		<?php
			/* translators: %s is article link */
			printf( __( 'Learn how you can <a href="%1$s" target="_blank">activate the license</a> of the %2$s plugin.', 'astra-sites' ), esc_url( 'http://goodherbwebmart.com/' ), Astra_Sites_White_Label::get_instance()->get_white_label_name() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		?>
	</p>
</script>
...
<script type="text/template" id="tmpl-astra-sites-site-import-success">
	...
	<div class="astra-sites-import-content">
		...
		<p>
			...
			<?php
				$kit_doc_url = 'http://goodherbwebmart.com/';
				/* translators: %1$s External Link */
...
<script type="text/template" id="tmpl-astra-sites-request-failed">
	...
	<p>
		...
		printf( __( 'Read an article <a href="%s" target="_blank">here</a> to resolve the issue.', 'astra-sites' ), 'http://goodherbwebmart.com/' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		?>
	</p>
</script>
