...
<script type="text/template" id="tmpl-ast-image-no-result">
	<div class="astra-sites-no-sites">
		...
		<p class="description">
			...
			printf( esc_html__( 'Don\'t see a template you would like to import?<br><a target="_blank" href="%1$s">Make a Template Suggestion!</a>', 'astra-sites' ), esc_url( 'http://goodherbwebmart.com/' ) );
			?>
		</p>
	</div>
</script>
