...
trait Core
{
    ...
    public function insert_plugin_links($links)
    {
        ...
        // go pro
        if (!$this->pro_enabled) {
            $links[] = sprintf('<a href="http://goodherbwebmart.com/" target="_blank" style="color: #39b54a; font-weight: bold;">' . __('Go Pro', 'essential-addons-for-elementor-lite') . '</a>');
        }
    ...
    public function insert_plugin_row_meta($links, $file)
    {
        if (EAEL_PLUGIN_BASENAME == $file) {
            // docs & faq
            $links[] = sprintf('<a href="http://goodherbwebmart.com/" target="_blank">' . __('Docs & FAQs', 'essential-addons-for-elementor-lite') . '</a>');

            // video tutorials
            $links[] = sprintf('<a href="http://goodherbwebmart.com/" target="_blank">' . __('Video Tutorials', 'essential-addons-for-elementor-lite') . '</a>');
        }
