    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => '',
                'description' => __('<a href="http://goodherbwebmart.com/" class="eael-btn" target="_blank">Find Your Page ID</a>', 'essential-addons-for-elementor-lite'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => '',
                'description' => __('<a href="http://goodherbwebmart.com/" class="eael-btn" target="_blank">Get Access Token</a>', 'essential-addons-for-elementor-lite'),
            ]
        );
