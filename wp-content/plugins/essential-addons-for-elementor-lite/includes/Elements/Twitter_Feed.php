    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => '<a href="http://goodherbwebmart.com/" target="_blank">Get Consumer Key.</a> Create a new app or select existing app and grab the <b>consumer key.</b>',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => '<a href="http://goodherbwebmart.com/" target="_blank">Get Consumer Secret.</a> Create a new app or select existing app and grab the <b>consumer secret.</b>',
            ]
        );
        ...
        if (!apply_filters('eael/pro_enabled', false)) {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '1',
                    'description' => '<span class="pro-feature"> Get the  <a href="http://goodherbwebmart.com/" target="_blank">Pro version</a> for more stunning elements and customization options.</span>',
                ]
            );
