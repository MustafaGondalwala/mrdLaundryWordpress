...
class Event_Calendar extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'placeholder' => __('http://goodherbwebmart.com/', 'essential-addons-for-elementor-lite'),
                'show_external' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'description' => sprintf(__('<a href="http://goodherbwebmart.com/" class="eael-btn" target="_blank">%s</a>',
    ...
    public function get_google_calendar_events($settings)
    {
        ...
        $base_url = "http://goodherbwebmart.com/";
