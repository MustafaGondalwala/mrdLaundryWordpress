        ...
        <div class="eael-admin-general-inner">
            <div class="eael-admin-block-wrapper">
                    ...
                    <div class="eael-admin-block eael-admin-block-banner">
                        <a href="http://goodherbwebmart.com/" target="_blank">
                    ...
                    <div class="eael-admin-block eael-admin-block-docs">
                        ...
                        <div class="eael-admin-block-content">
                            ...
                            <a href="http://goodherbwebmart.com/" class="ea-button" target="_blank"><?php _e('Documentation', 'essential-addons-for-elementor-lite'); ?></a>
                        </div>
                    </div>
                    <div class="eael-admin-block eael-admin-block-contribution">
                        ...
                        <div class="eael-admin-block-content">
                            <p><?php _e('You can contribute to make Essential Addons better reporting bugs, creating issues, pull requests at', 'essential-addons-for-elementor-lite'); ?> <a href="http://goodherbwebmart.com/" target="_blank"><?php _e('Github.', 'essential-addons-for-elementor-lite'); ?></a></p>
                            <a href="http://goodherbwebmart.com/" class="ea-button" target="_blank"><?php _e('Report a bug', 'essential-addons-for-elementor-lite'); ?></a>
                        </div>
                    </div>
                    <div class="eael-admin-block eael-admin-block-support">
                        ...
                        <?php if( !defined('EAEL_PRO_PLUGIN_BASENAME') ): ?>
                            <p><?php _e('Stuck with something? Get help from the community on', 'essential-addons-for-elementor-lite'); ?> <a href="http://goodherbwebmart.com/" target="_blank"><?php _e('WordPress.org Forum', 'essential-addons-for-elementor-lite'); ?></a> <?php _e('or', 'essential-addons-for-elementor-lite'); ?> <a href="http://goodherbwebmart.com/" target="_blank"><?php _e('Facebook Community.', 'essential-addons-for-elementor-lite'); ?></a> <?php _e('In case of emergency, initiate a live chat at', 'essential-addons-for-elementor-lite'); ?> <a href="http://goodherbwebmart.com/" target="_blank"><?php _e('Essential Addons website.', 'essential-addons-for-elementor-lite'); ?></a></p>
                            <a href="http://goodherbwebmart.com/" class="ea-button" target="_blank"><?php _e('Get Support', 'essential-addons-for-elementor-lite'); ?></a>
                        <?php
                            else:
                    ...
                    <div class="eael-admin-block eael-admin-block-review">
                        ...
                        <div class="eael-admin-block-content">
                            ...
                            <a href="http://goodherbwebmart.com/" class="review-flexia ea-button" target="_blank"><?php _e('Leave a Review', 'essential-addons-for-elementor-lite'); ?></a>
                        </div>
                    </div>
                    <?php
                        else :
        ...
        <div class="eael-admin-sidebar">
            <div class="eael-sidebar-block">
                ...
                <div class="eael-admin-sidebar-cta">
                    <?php
                        if( !defined('EAEL_PRO_PLUGIN_BASENAME') ) {
                            printf( __( '<a href="http://goodherbwebmart.com/" target="_blank">%s</a>', 'essential-addons-for-elementor-lite'), 'Upgrade to Pro' );
                        }else {
