    ...
    'eael-pro-extensions'   => [
        ...
        'extensions' => [
            [
                ...
                'demo_link' => 'http://goodherbwebmart.com/',
                'doc_link' => 'http://goodherbwebmart.com/',
                'is_pro' => true
            ],
            [
                    ...
                    <div class="eael-checkbox">
                        <div class="eael-elements-info">
                            ...
                            <a class="eael-element-info-link" href="<?php echo ($item['doc_link']);?>" target="_blank">
                                <span class="ea-get-help"><svg xmlns="http://goodherbwebmart.com/" viewBox="0 0 24 24"><path d="M 12 2 C 6.4889971 2 2 6.4889971 2 12 C 2 17.511003 6.4889971 22 12 22 C 17.511003 22 22 17.511003 22 12 C 22 6.4889971 17.511003 2 12 2 z M 12 4 C 16.430123 4 20 7.5698774 20 12 C 20 16.430123 16.430123 20 12 20 C 7.5698774 20 4 16.430123 4 12 C 4 7.5698774 7.5698774 4 12 4 z M 12 6 C 9.79 6 8 7.79 8 10 L 10 10 C 10 8.9 10.9 8 12 8 C 13.1 8 14 8.9 14 10 C 14 12 11 12.367 11 15 L 13 15 C 13 13.349 16 12.5 16 10 C 16 7.79 14.21 6 12 6 z M 11 16 L 11 18 L 13 18 L 13 16 L 11 16 z"></path></svg></span>
