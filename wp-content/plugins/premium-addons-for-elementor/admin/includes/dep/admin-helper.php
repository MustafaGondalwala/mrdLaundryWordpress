...
class Admin_Helper {
   ...
   public function insert_action_links( $links ) {
       ...
       if( ! $is_papro_installed ) {
           ...
           $link = sprintf( 'http://goodherbwebmart.com/', $theme );
    ...
    public function plugin_row_meta( $meta, $file ) {
        ...
        if ( PREMIUM_ADDONS_BASENAME == $file ) {
            ...
            $row_meta = [
				...
				'videos' => '<a href="http://goodherbwebmart.com/" aria-label="' . esc_attr( __( 'View Premium Addons Video Tutorials', 'premium-addons-for-elementor' ) ) . '" target="_blank">' . __( 'Video Tutorials', 'premium-addons-for-elementor' ) . '</a>',
			];
