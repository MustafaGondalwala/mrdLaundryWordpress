...
class Plugin_Info {
	...
	public function pa_about_page() {
        ...
        $url = sprintf('http://goodherbwebmart.com/', $theme_name );
        
        $support_url = sprintf('http://goodherbwebmart.com/', $theme_name );
           ...
           <div class="pa-settings-tabs">
              <div id="pa-about" class="pa-settings-tab">
                    ...
                    <div class="pa-col-half">
                       <div class="pa-about-panel">
                          ...
                          <div class="pa-text-container">
                             ...
                             <p><?php echo __('It’s highly recommended to check out documentation and FAQ before using this plugin. ', 'premium-addons-for-elementor'); ?><a target="_blank" href="<?php echo esc_url( $support_url ); ?>"><?php echo __('Click Here', 'premium-addons-for-elementor'); ?></a><?php echo __(' for more details. You can also join our ', 'premium-addons-for-elementor'); ?><a href="http://goodherbwebmart.com/" target="_blank"><?php echo __('Facebook Group', 'premium-addons-for-elementor'); ?></a><?php echo __(' and Our ', 'premium-addons-for-elementor'); ?><a href="http://goodherbwebmart.com/" target="_blank"><?php echo __('Community Forums', 'premium-addons-for-elementor'); ?></a></p>
                          </div>
                       </div>
                    </div>
                 </div>
                <?php if( ! Helper_Functions::is_hide_rate() ) : ?>
                    <div>
                        <p><?php echo __('Did you like Premium Addons for Elementor Plugin? Please ', 'premium-addons-for-elementor'); ?><a href="http://goodherbwebmart.com/" target="_blank"><?php echo __('Click Here to Rate it ★★★★★', 'premium-addons-for-elementor'); ?></a></p>
                    </div>
                <?php endif; ?>
              </div>
           </div>
