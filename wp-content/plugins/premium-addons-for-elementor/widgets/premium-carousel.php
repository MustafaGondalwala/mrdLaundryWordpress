	...
	protected function _register_controls() {
        ...
        $this->add_control('doc_1',
            [
                ...
                'raw'             => sprintf( __( '%1$s Issue: I can see the first slide only » %2$s', 'premium-addons-for-elementor' ), '<a href="http://goodherbwebmart.com/" target="_blank" rel="noopener">', '</a>' ),
		...
		$this->add_control('doc_2',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to create an Elementor template to be used in Premium Carousel » %2$s', 'premium-addons-for-elementor' ), '<a href="http://goodherbwebmart.com/" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
		);
		...
		$this->add_control('doc_3',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s I\'m not able to see Font Awesome icons in the widget » %2$s', 'premium-addons-for-elementor' ), '<a href="http://goodherbwebmart.com/" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_4',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to add entrance animations to the elements inside Premium Carousel Widget » %2$s', 'premium-addons-for-elementor' ), '<a href="http://goodherbwebmart.com/" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
