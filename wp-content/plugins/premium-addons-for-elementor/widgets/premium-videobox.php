    ...
    protected function _register_controls() {
        ...
        $this->add_control('premium_video_box_video_embed', 
            [
                ...
                'description'   => __('Enter your YouTube/Vimeo video link. For example, http://goodherbwebmart.com/', 'premium-addons-for-elementor'),
                'type'          => Controls_Manager::HIDDEN,
                'condition'     => [
                    'premium_video_box_video_type!' => 'self',
        ...
        $this->add_control('premium_video_box_link', 
            [
                ...
                'label_block'   => true,
                'default'       => 'http://goodherbwebmart.com/',
                'dynamic'       => [
                    'active' => true,
                    'categories' => [
    ...
    private function get_video_params() {
        ...
        if ( ! empty( $link ) ) {
            if ( 'youtube' === $type ) {
                ...
                $link = sprintf( 'http://goodherbwebmart.com/', $video_id );
            }
            ...
            if( 'id' === $identifier ) {
                $link = 'youtube' === $type ? sprintf('http://goodherbwebmart.com/', $id ) : sprintf('http://goodherbwebmart.com/', $id );
            } else {
                $link = $embed;
            }
