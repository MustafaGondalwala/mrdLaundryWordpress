    ...
    protected function _register_controls() {
        ...
        $this->add_control('premium_button_link',
                [
                    ...
                    'placeholder'   => 'http://goodherbwebmart.com/',
                    'label_block'   => true,
                    'separator'     => 'after',
                    'condition'     => [
        ...
        $this->add_control('lottie_url', 
            [
                ...
                'type'              => Controls_Manager::TEXT,
                'dynamic'           => [ 'active' => true ],
                'description'       => 'Get JSON code URL from <a href="http://goodherbwebmart.com/" target="_blank">here</a>',
                'label_block'       => true,
                'condition'         => [
                    'premium_button_icon_switcher'  => 'yes',
                    'premium_button_hover_effect!'  => 'style4',
        ...
        $this->add_control('doc_2',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to open an Elementor popup using button widget » %2$s', 'premium-addons-for-elementor' ), '<a href="http://goodherbwebmart.com/" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_3',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to play/pause a soundtrack using button widget » %2$s', 'premium-addons-for-elementor' ), '<a href="http://goodherbwebmart.com/" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
