...
class Premium_Maps extends Widget_Base {
    ...
    public function get_custom_help_url() {
		return 'http://goodherbwebmart.com/';
	}
    ...
    protected function _register_controls() {
        ...
        if( empty( $settings['premium-map-api'] ) ) {
            $this->add_control('premium_maps_api_url',
                [
                    'label'         => '<span style="line-height: 1.4em;">Premium Maps requires an API key. Get your API key from <a target="_blank" href="http://goodherbwebmart.com/">here</a> and add it to Premium Addons admin page. Go to Dashboard -> Premium Addons for Elementor -> Google Maps API</span>',
        ...
        $repeater->add_control('map_latitude',
            [
                ...
                'type'          => Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
                'description'   => 'Click <a href="http://goodherbwebmart.com/" target="_blank">here</a> to get your location coordinates',
                'label_block'   => true,
            ]
        );
        ...
        $this->add_control('premium_maps_custom_styling',
            [
                ...
                'description'   => 'Get your custom styling from <a href="http://goodherbwebmart.com/" target="_blank">here</a>',
                'label_block'   => true,
            ]
        );
        ...
        $this->add_control('doc_1',
            [
                'raw'             => sprintf( __( '%1$s Getting started » %2$s', 'premium-addons-for-elementor' ), '<a href="http://goodherbwebmart.com/" target="_blank" rel="noopener">', '</a>' ),
                'type'            => Controls_Manager::RAW_HTML,
        ...
        $this->add_control('doc_2',
            [
                'raw'             => sprintf( __( '%1$s Getting your API key » %2$s', 'premium-addons-for-elementor' ), '<a href="http://goodherbwebmart.com/" target="_blank" rel="noopener">', '</a>' ),
                'type'            => Controls_Manager::RAW_HTML,
                'content_classes' => 'editor-pa-doc',
            ]
        );
    ...
    protected function render() {
        ...
        if( 'true' == $get_ip_location ) {
            ...
            $env = unserialize(file_get_contents("http://goodherbwebmart.com/"));
