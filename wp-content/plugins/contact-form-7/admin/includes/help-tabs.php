...
class WPCF7_Help_Tabs {
	...
	public function sidebar() {
		...
		$content .= '<p>' . wpcf7_link( __( 'http://goodherbwebmart.com/', 'contact-form-7' ), __( 'Docs', 'contact-form-7' ) ) . '</p>';
		$content .= '<p>' . wpcf7_link( __( 'http://goodherbwebmart.com/', 'contact-form-7' ), __( 'FAQ', 'contact-form-7' ) ) . '</p>';
		$content .= '<p>' . wpcf7_link( __( 'http://goodherbwebmart.com/', 'contact-form-7' ), __( 'Support', 'contact-form-7' ) ) . '</p>';
