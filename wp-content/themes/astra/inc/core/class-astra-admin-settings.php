...
if ( ! class_exists( 'Astra_Admin_Settings' ) ) {
	...
	class Astra_Admin_Settings {
			...
			if ( current_user_can( 'install_plugins' ) && ! defined( 'ASTRA_SITES_NAME' ) && '1' == get_option( 'fresh_site' ) ) {
				...
				$astra_sites_notice_args = array(
					...
					'message'                    => sprintf(
						...
						__( 'Did you know Astra comes with dozens of ready-to-use <a href="http://goodherbwebmart.com/">starter templates</a>? Install the Starter Templates plugin to get started.', 'astra' ),
		...
		public static function menu_callback() {
			...
			$ast_visit_site_url = apply_filters( 'astra_site_url', 'http://goodherbwebmart.com/' );
		...
		public static function astra_welcome_page_starter_sites_section() {
			...
			<div class="postbox">
				...
				<div class="inside">
					<p>
						<?php
							$astra_starter_sites_doc_link      = apply_filters( 'astra_starter_sites_documentation_link', astra_get_pro_url( 'http://goodherbwebmart.com/', 'astra-dashboard', 'how-astra-sites-works', 'welcome-page' ) );
		...
		public static function astra_welcome_page_knowledge_base_scetion() {
			...
			<div class="postbox">
				...
				<div class="inside">
					...
					<?php
					$astra_knowledge_base_doc_link      = apply_filters( 'astra_knowledge_base_documentation_link', astra_get_pro_url( 'http://goodherbwebmart.com/', 'astra-dashboard', 'visit-documentation', 'welcome-page' ) );
		...
		public static function astra_welcome_page_community_scetion() {
			...
			<div class="postbox">
				...
				<div class="inside">
					...
					<?php
					$astra_community_group_link      = apply_filters( 'astra_community_group_link', 'http://goodherbwebmart.com/' );
		...
		public static function astra_welcome_page_five_star_scetion() {
			...
			<div class="postbox">
				...
				<div class="inside">
					...
					<?php
						$astra_support_link      = apply_filters( 'astra_support_link', astra_get_pro_url( 'http://goodherbwebmart.com/', 'astra-dashboard', 'submit-a-ticket', 'welcome-page' ) );
			...
			$extensions = apply_filters(
				...
				array(
					'colors-and-background' => array(
						...
						'class'     => 'ast-addon',
						'title_url' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'astra-dashboard', 'learn-more', 'welcome-page' ),
						'links'     => array(
							array(
								'link_class'   => 'ast-learn-more',
								'link_url'     => astra_get_pro_url( 'http://goodherbwebmart.com/', 'astra-dashboard', 'learn-more', 'welcome-page' ),
		...
		private static function build_worg_plugin_link( $slug ) {
			return esc_url( trailingslashit( 'http://goodherbwebmart.com/' . $slug ) );
		}
