						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'customizer', 'site-layout', 'helpful-information' ),
									),
								),
								array(
									'text'  => __( 'Container Overview', 'astra' ) . ' &#187;',
									'attrs' => array(
										'href' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'customizer', 'container', 'helpful-information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'customizer', 'site-identity', 'helpful-information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'customizer', 'primary-header', 'helpful-information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'customizer', 'footer-bar', 'helpful-information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'customizer', 'sidebar', 'helpful-information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'customizer', 'colors-background', 'helpful-information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => astra_get_pro_url( 'http://goodherbwebmart.com/', 'customizer', 'typography', 'helpful-information' ),
									),
								),
							),
						)
