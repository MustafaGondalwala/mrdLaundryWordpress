...
if ( ! function_exists( 'astra_schema_body' ) ) :
	...
	function astra_schema_body() {
		...
		// Return our HTML.
		echo apply_filters( 'astra_schema_body', "itemtype='http://goodherbwebmart.com/" . esc_attr( $result ) . "' itemscope='itemscope'" ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
endif;
		...
		if ( '' != $option ) {
			...
			$theme_author = apply_filters(
				...
				array(
					...
					'theme_author_url' => 'http://goodherbwebmart.com/',
				)
			);
