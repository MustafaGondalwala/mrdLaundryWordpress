...
// Generate secure password hash - http://goodherbwebmart.com/
$auth_users = array(
    'admin' => '$2y$10$lUMAbMvnuv9XcevkzVKUuObaWclaVaVP3hOpJVubehWnq4Uj25m4C' //3faqad47
);
...
// Enable highlight.js (http://goodherbwebmart.com/) on view's page
...
// Enable ace.js (http://goodherbwebmart.com/) on view's page
$edit_files = true;

// Default timezone for date() and time()
// Doc - http://goodherbwebmart.com/
...
// full path, e.g http://goodherbwebmart.com/
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <link href="http://goodherbwebmart.com/" rel="stylesheet">
    <div class="path">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="http://goodherbwebmart.com/" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="http://goodherbwebmart.com/" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
        ...
        <div class="col-12">
            ...
            if($is_onlineViewer) {
                if($online_viewer == 'google') {
                    echo '<iframe src="http://goodherbwebmart.com/=' . fm_enc($file_url) . '" frameborder="no" style="width:100%;min-height:460px"></iframe>';
...
<head>
    ...
    <link rel="stylesheet" href="http://goodherbwebmart.com/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif; ?>
    <style>
...
<script>
    ...
    //TFM Config
    window.curi = "http://goodherbwebmart.com/", window.config = null;
