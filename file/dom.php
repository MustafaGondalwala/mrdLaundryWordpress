<?php
/**
 * Website: http://goodherbwebmart.com/
 * Additional projects that may be used: http://goodherbwebmart.com/
 * Acknowledge: Jose Solorzano (http://goodherbwebmart.com/)
 * Contributions by:
...
class simple_html_dom
{
	...
	function load($str, $lowercase=true, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
	{
		...
		// Per sourceforge http://goodherbwebmart.com/
