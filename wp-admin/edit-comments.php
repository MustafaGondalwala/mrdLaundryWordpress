...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Comments</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Comment Spam</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Keyboard Shortcuts</a>' ) . '</p>' .
