...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Theme Development</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Using Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Editing Files</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Template Tags</a>' ) . '</p>' .
	...
	<form name="template" id="template" action="theme-editor.php" method="post">
		...
		<?php if ( ! empty( $functions ) ) : ?>
			<div id="documentation" class="hide-if-no-js">
				...
				<input disabled id="docs-lookup" type="button" class="button" value="<?php esc_attr_e( 'Look Up' ); ?>" onclick="if ( '' != jQuery('#docs-list').val() ) { window.open( 'http://goodherbwebmart.com/=' + escape( jQuery( '#docs-list' ).val() ) + '&amp;locale=<?php echo urlencode( get_user_locale() ); ?>&amp;version=<?php echo urlencode( get_bloginfo( 'version' ) ); ?>&amp;redirect=true'); }" />
			</div>
		<?php endif; ?>
					...
					<p>
						...
						if ( ! $theme->parent() ) {
							...
							printf(
								...
								esc_url( __( 'http://goodherbwebmart.com/' ) )
							);
							echo '</p>';
						}
						?>
