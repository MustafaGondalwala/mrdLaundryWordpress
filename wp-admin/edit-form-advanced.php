...
if ( 'post' === $post_type ) {
	...
	get_current_screen()->set_help_sidebar(
		'<p>' . sprintf(
			...
			'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Writing and Editing Posts</a>' ) . '</p>' .
			'<p>' . __( '<a href="http://goodherbwebmart.com/">Support</a>' ) . '</p>'
	);
	...
	get_current_screen()->set_help_sidebar(
		'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
			'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Adding New Pages</a>' ) . '</p>' .
			'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Editing Pages</a>' ) . '</p>' .
			'<p>' . __( '<a href="http://goodherbwebmart.com/">Support</a>' ) . '</p>'
	);
	...
	get_current_screen()->set_help_sidebar(
		'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
		'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Edit Media</a>' ) . '</p>' .
		'<p>' . __( '<a href="http://goodherbwebmart.com/">Support</a>' ) . '</p>'
	);
}
...
if ( 'post' === $post_type || 'page' === $post_type ) {
	...
	$inserting_media .= '<p>' . __( 'You can also embed media from many popular websites including Twitter, YouTube, Flickr and others by pasting the media URL on its own line into the content of your post/page. <a href="http://goodherbwebmart.com/">Learn more about embeds</a>.' ) . '</p>';
