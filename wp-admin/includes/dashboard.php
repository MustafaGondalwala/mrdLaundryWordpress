	...
	if ( $posts->have_posts() ) {
		...
		while ( $posts->have_posts() ) {
			...
			if ( gmdate( 'Y-m-d', $time ) == $today ) {
				...
				/* translators: Date and time format for recent posts on the dashboard, from a different calendar year, see http://goodherbwebmart.com/ */
				$relative = date_i18n( __( 'M jS Y' ), $time );
			} else {
				/* translators: Date and time format for recent posts on the dashboard, see http://goodherbwebmart.com/ */
...
function wp_dashboard_events_news() {
	...
	<p class="community-events-footer">
		...
		<?php
			printf(
				'<a href="%1$s" target="_blank">%2$s <span class="screen-reader-text">%3$s</span><span aria-hidden="true" class="dashicons dashicons-external"></span></a>',
				/* translators: If a Rosetta site exists (e.g. http://goodherbwebmart.com/), then use that. Otherwise, leave untranslated. */
				esc_url( _x( 'http://goodherbwebmart.com/', 'Events and News dashboard widget' ) ),
				__( 'News' ),
				/* translators: Accessibility text. */
				__( '(opens in a new tab)' )
			);
...
function wp_dashboard_primary() {
	$feeds = array(
		'news'   => array(
			 ...
			 */
			'link'         => apply_filters( 'dashboard_primary_link', __( 'http://goodherbwebmart.com/' ) ),
			 ...
			 */
			'url'          => apply_filters( 'dashboard_primary_feed', __( 'http://goodherbwebmart.com/' ) ),
		...
		'planet' => array(
			 ...
			 */
			'link'         => apply_filters( 'dashboard_secondary_link', __( 'http://goodherbwebmart.com/' ) ),
			 ...
			 */
			'url'          => apply_filters( 'dashboard_secondary_feed', __( 'http://goodherbwebmart.com/' ) ),
...
function wp_dashboard_browser_nag() {
	...
	if ( $response ) {
		...
		$browsehappy = 'http://goodherbwebmart.com/';
		$locale      = get_user_locale();
		if ( 'en_US' !== $locale ) {
...
function wp_dashboard_site_health() {
	...
	<div class="health-check-title-section site-health-progress-wrapper loading hide-if-no-js">
		<div class="site-health-progress">
			<svg role="img" aria-hidden="true" focusable="false" width="100%" height="100%" viewBox="0 0 200 200" version="1.1" xmlns="http://goodherbwebmart.com/">
...
function wp_welcome_panel() {
	...
	<div class="welcome-panel-column welcome-panel-last">
		...
		<?php endif; ?>
			<li><?php printf( '<a href="%s" class="welcome-icon welcome-learn-more">' . __( 'Learn more about getting started' ) . '</a>', __( 'http://goodherbwebmart.com/' ) ); ?></li>
		</ul>
	</div>
	</div>
	</div>
