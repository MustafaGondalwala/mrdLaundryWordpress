 ...
 *         {@link http://goodherbwebmart.com/ function reference article}
...
<div id="<?php echo $_tab; ?>-content" class='<?php echo $_with_banner; ?>'>
	<div class="fyi">
		<ul>
			...
			<?php } if ( ! empty( $api->slug ) && empty( $api->external ) ) { ?>
				<li><a target="_blank" href="<?php echo __( 'http://goodherbwebmart.com/' ) . $api->slug; ?>/"><?php _e( 'WordPress.org Plugin Page &#187;' ); ?></a></li>
				...
				<div class="counter-container">
						<span class="counter-label">
							...
							printf(
								...
								"http://goodherbwebmart.com/->slug}/reviews/?filter={$key}",
								$aria_label,
	...
	foreach ( (array) $api->sections as $section_name => $content ) {
		$content = links_add_base_url( $content, 'http://goodherbwebmart.com/' . $api->slug . '/' );
