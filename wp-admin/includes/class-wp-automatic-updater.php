...
class WP_Automatic_Updater {
	...
	protected function send_plugin_theme_email( $type, $successful_updates, $failed_updates ) {
		...
		$body[] = __( 'http://goodherbwebmart.com/' );
		$body[] = "\n" . __( 'The WordPress Team' );
 ...
 * Open a thread in the support forums: http://goodherbwebmart.com/
 * Or, if you're comfortable writing a bug report: http://goodherbwebmart.com/
