...
function populate_options( array $options = array() ) {
	 ...
	 * or a valid timezone string (America/New_York). See http://goodherbwebmart.com/
	...
	$defaults = array(
		...
		'posts_per_page'                  => 10,
		/* translators: Default date format, see http://goodherbwebmart.com/ */
		'date_format'                     => __( 'F j, Y' ),
		/* translators: Default time format, see http://goodherbwebmart.com/ */
		'time_format'                     => __( 'g:i a' ),
		/* translators: Links last updated date format, see http://goodherbwebmart.com/ */
		...
		'category_base'                   => '',
		'ping_sites'                      => 'http://goodherbwebmart.com/',
		'comment_max_links'               => 2,
