...
class WP_Community_Events {
	...
	public function get_events( $location_search = '', $timezone = '' ) {
		...
		$api_url                    = 'http://goodherbwebmart.com/';
	 ...
	 *
	 * Modified from http://goodherbwebmart.com/, MIT license.
	 * Modified from http://goodherbwebmart.com/, MIT license.
	 *
	...
	protected function format_event_data_time( $response_body ) {
		if ( isset( $response_body['events'] ) ) {
			foreach ( $response_body['events'] as $key => $event ) {
				 ...
				 */
				/* translators: Date format for upcoming events on the dashboard. Include the day of the week. See http://goodherbwebmart.com/ */
				...
				if ( isset( $event['end_date'] ) ) {
					...
					if ( 'meetup' !== $event['type'] && $formatted_end_date !== $formatted_date ) {
						/* translators: Upcoming events month format. See http://goodherbwebmart.com/ */
						...
						if ( $start_month === $end_month ) {
							$formatted_date = sprintf(
								...
								__( '%1$s %2$d–%3$d, %4$d' ),
								$start_month,
								/* translators: Upcoming events day format. See http://goodherbwebmart.com/ */
								date_i18n( _x( 'j', 'upcoming events day format' ), $timestamp ),
								date_i18n( _x( 'j', 'upcoming events day format' ), $end_timestamp ),
								/* translators: Upcoming events year format. See http://goodherbwebmart.com/ */
