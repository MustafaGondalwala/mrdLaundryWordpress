...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Managing Users</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Descriptions of Roles and Capabilities</a>' ) . '</p>' .
