...
/* translators: Date and time format for exact current time, mainly about timezones, see http://goodherbwebmart.com/ */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on General Settings</a>' ) . '</p>' .
...
foreach ( $time_formats as $format ) {
	...
	echo "\t<p class='date-time-doc'>" . __( '<a href="http://goodherbwebmart.com/">Documentation on date and time formatting</a>.' ) . "</p>\n";
?>
	</fieldset>
</td>
</tr>
