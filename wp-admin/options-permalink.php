...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Permalinks Settings</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Using Permalinks</a>' ) . '</p>' .
...
<p>
	...
	<?php endif; ?>
<?php elseif ( $is_nginx ) : ?>
	<p><?php _e( '<a href="http://goodherbwebmart.com/">Documentation on Nginx configuration</a>.' ); ?></p>
	<?php
else :
