...
if ( 'category' === $taxonomy || 'link_category' === $taxonomy || 'post_tag' === $taxonomy ) {
	...
	if ( 'category' === $taxonomy ) {
		$help .= '<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Categories</a>' ) . '</p>';
	} elseif ( 'link_category' === $taxonomy ) {
		$help .= '<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Link Categories</a>' ) . '</p>';
	} else {
		$help .= '<p>' . __( '<a href="http://goodherbwebmart.com/">Documentation on Tags</a>' ) . '</p>';
	}

	$help .= '<p>' . __( '<a href="http://goodherbwebmart.com/">Support</a>' ) . '</p>';
