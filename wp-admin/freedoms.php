...
<div class="wrap about__container">
	...
	<div class="about__section has-subtle-background-color is-feature">
		...
		<?php
		printf(
			/* translators: %s: http://goodherbwebmart.com/ */
	...
	<div class="about__section">
		<div class="column">
			...
			<p>
			<?php
			$plugins_url = current_user_can( 'activate_plugins' ) ? admin_url( 'plugins.php' ) : __( 'http://goodherbwebmart.com/' );
			$themes_url  = current_user_can( 'switch_themes' ) ? admin_url( 'themes.php' ) : __( 'http://goodherbwebmart.com/' );
			printf(
				/* translators: 1: URL to Plugins screen, 2: URL to Themes screen, 3: http://goodherbwebmart.com/ */
			...
			<p><?php _e( 'Don&#8217;t you wish all software came with these freedoms? So do we! For more information, check out the <a href="http://goodherbwebmart.com/">Free Software Foundation</a>.' ); ?></p>
		</div>
	</div>
